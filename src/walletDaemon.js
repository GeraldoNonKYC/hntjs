...
module.exports = class walletNode extends EventEmitter {
  constructor (nodeAddress, readyCallback) {
    ...
    const packageDefinition = protoLoader.loadSync(__dirname + '/../protos/htnwalletd.proto', {
      keepCase: true,
      longs: String,
      enums: String,
      defaults: true,
      oneofs: true
		...
		const { htnwalletd } = gRPC.loadPackageDefinition(packageDefinition).htnwalletd

    this._client = new htnwalletd(nodeAddress, gRPC.credentials.createInsecure(), {  
